...
#         # CRITICAL: The base-href MUST match your GitHub repository name! ( flutter build web --release --wasm --base-href "/Harmony-Music/" )
#         flutter build web --release --wasm --base-href "/Harmony-Music/"
#     fi
